<nav class="bg-light d-flex align-items-center justify-content-between">
    ...
    <ul class="nav-links m-0 d-flex align-items-center justify-content-between">
        ...
        <li>
            <a class="btn btn-success text-light" href="/project/addPoject"><i
                    class="fa-solid px-2 fa-circle-plus"></i>Add project</a>
        </li>
        <li>
            <a class="btn btn-dark text-light" href="/editProfile"><i class="fa-solid fa-user-pen px-2"></i>Edit
                profile</a>
        </li>
        <li>
            <form action="{{ route('logout') }}" method="post">
                ...
                <button class="btn btn-danger text-light">
                    Log Out<i class="fa-solid fa-arrow-right-from-bracket px-2"></i>
                </button>
            </form>
        </li>
    </ul>
