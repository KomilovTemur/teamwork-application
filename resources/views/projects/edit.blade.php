    ...
    <div class="row">
      ...
      <div class="col-md-8">
        @if ($project->user[0]->id == auth()->id())
          <form action="{{ route('projects.update', $project->id) }}" method="post" class="d-flex w-100 flex-column">
            ...
            <label>
              Description
              <textarea class="form-control ckeditor" type="text" value="" name="description" id="" cols="30"
      ...
      <div class="col-md-4">
        @if (count($project->user) > 1)
          @if ($project->user[0]->id == auth()->id())
            <a href="{{ route('projects.show', $project->id) }}" class="btn btn-warning w-100 mb-2">
